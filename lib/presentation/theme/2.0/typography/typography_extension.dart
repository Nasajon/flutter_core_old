...
class AppTextStyle extends ThemeExtension<AppTextStyle> {
  ...
  /// Default bodyText2 text style with FontWeight.light
  final TextStyle body2Light;

  /// Default bodyText2 text style with FontWeight.normal
  final TextStyle body2;

  /// Default bodyText2 with FontWeight.medium
  final TextStyle body2Medium;

  /// Default bodyText2 with FontWeight.bold
  final TextStyle body2Bold;

  /// Default bodyText1 with FontWeight.light
  final TextStyle body1Light;

  /// Default bodyText1 with FontWeight.normal
  final TextStyle body1;

  /// Default bodyText1 with FontWeight.medium
  final TextStyle body1Medium;

  /// Default bodyText1 with FontWeight.bold
  final TextStyle body1Bold;

  /// Default headline4 with FontWeight.light
  final TextStyle h4Light;

  /// Default headline4 with FontWeight.normal
  final TextStyle h4;

  /// Default headline4 with FontWeight.medium
  final TextStyle h4Medium;

  /// Default headline4 with FontWeight.bold
  final TextStyle h4Bold;

  /// Default headline3 with FontWeight.light
  final TextStyle h3Light;

  /// Default headline3 with FontWeight.normal
  final TextStyle h3;

  /// Default headline3 with FontWeight.medium
  final TextStyle h3Medium;

  /// Default headline3 with FontWeight.bold
  final TextStyle h3Bold;

  /// Default headline2 with FontWeight.light
  final TextStyle h2Light;

  /// Default headline2 with FontWeight.normal
  final TextStyle h2;

  /// Default headline2 with FontWeight.medium
  final TextStyle h2Medium;

  /// Default headline2 with FontWeight.bold
  final TextStyle h2Bold;

  /// Default headline1 with FontWeight.light
  final TextStyle h1Light;

  /// Default headline1 with FontWeight.normal
  final TextStyle h1;

  /// Default headline1 with FontWeight.medium
  final TextStyle h1Medium;

  /// Default headline1 with FontWeight.bold
