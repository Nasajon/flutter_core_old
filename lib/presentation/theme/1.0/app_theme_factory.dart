  ...
  static ThemeData createLightTheme() {
    ...
    return ThemeData(
      ...
      colorScheme: const ColorScheme(
        ...
        primaryContainer: AppThemeBase.colorPrimaryDarkest,
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ButtonStyle(
          ...
          backgroundColor: MaterialStateProperty.resolveWith((states) {
            ...
            return AppThemeBase.colorPrimaryLight;
          }),
      ...
      textTheme: TextTheme(
        ...
        headline4: TextStyle(
          fontSize: AppThemeBase.fontSizeH4,
          fontWeight: AppThemeBase.fontWeightBold,
          color: AppThemeBase.colorPrimaryDark,
          height: AppThemeBase.lineHeightMedium,
        ),
      ...
      tabBarTheme: TabBarTheme(
        labelPadding: EdgeInsets.symmetric(horizontal: 14.responsiveWidth),
      ),
    );
  }
  ...
  static ThemeData createDarkTheme() {
    ...
    return themeData.copyWith(
      ...
      textTheme: themeData.textTheme.copyWith(
        ...
        headline2: themeData.textTheme.headline2?.copyWith(
          color: AppThemeBase.colorPrimarySuperlight,
        ),
        headline3: themeData.textTheme.headline3?.copyWith(
          color: AppThemeBase.colorPrimarySuperlight,
        ),
