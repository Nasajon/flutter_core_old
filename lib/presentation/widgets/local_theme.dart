...
class LocalTheme extends StatelessWidget {
  ...
  ///
  /// Creates an area that respects a custom [ThemeData], defined in [theme] argument.
  ///
  ...
  ///
  /// Creates an area with the inverted theme, using as base the current context theme.
  /// If theme in [context] is dark, the theme applied to the builder is light and vice-versa.
  ///
  /// If this widget is applied to a full page, remember to check
  /// [invertSystemUiOverlayStyle] to true.
  ///
  ...
  Widget build(BuildContext context) {
    final styledWidget = Theme(data: theme, child: Builder(builder: builder));
